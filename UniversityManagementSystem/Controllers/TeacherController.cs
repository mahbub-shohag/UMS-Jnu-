...
namespace UniversityManagementSystem.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TeacherId,Name,Email,ContactNo,DesignationId,DepartmentId,CreditTaken")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TeacherId,Name,Email,ContactNo,DesignationId,DepartmentId,CreditTaken")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            var teacher = db.Teachers.FirstOrDefault(d => d.Email == email);
